...
public final class Config {
	...
	public static void load() {
		_log.debug("Loading GameServer config.");
		...
		// rates.properties
		_log.debug("Loading Rates config.");
		try {
		...
		_log.debug("Loading AltSettings config.");
		try {
		...
		_log.debug("Loading CharSettings config.");
		try {
		...
		_log.debug("Loading PcCommandSettings config.");
		try {
